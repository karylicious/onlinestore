...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    Font-Size="0.8em" ForeColor="#333333" Height="182px" style="font-size: small" 
    Width="416px" onauthenticate="Login1_Authenticate">
    <InstructionTextStyle Font-Italic="True" ForeColor="Black" />
    <LayoutTemplate>
        <table cellpadding="4" cellspacing="0" style="border-collapse:collapse;">
            <tr>
                <td>
                    <table cellpadding="0" style="height:182px;width:416px;">
                        <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:LinkButton ID="LinkButton1" runat="server">Esqueceu-se da palavra-passe?</asp:LinkButton>
                            </td>
                        </tr>
                        <tr>
